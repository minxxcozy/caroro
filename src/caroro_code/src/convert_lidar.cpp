...
class LidarConvert : public ros::NodeHandle 
{
    ...
    private:
        ...
        void lidarCallback(const sensor_msgs::LaserScan::ConstPtr& msg)
        {
            ...
            transform(msg->ranges.begin(), msg->ranges.begin()+180, scan_msg_.ranges.begin()+180, [](auto value){ return value; });
            transform(msg->ranges.begin()+180, msg->ranges.end(), scan_msg_.ranges.begin(), [](auto value){ return value; });
